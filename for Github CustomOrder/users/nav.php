  ...
  <div class="container-fluid">
    ...
    <ul class="nav nav-underline me-5 align-items-center">
        <li class="nav-item me-5">
          <a class="nav-link <?php echo activate_link(1); ?>   text-dark" aria-current="page" href="index.php?page=1">MAKE YOUR OWN PIZZA</a>
        </li>
        <li class="nav-item me-5">
          <a class="nav-link <?php echo activate_link(2); ?> text-dark"  href="index.php?page=2">BUNDLE DEALS</a>
        </li>
