    ...
    <div class="col">
        ...
        if(isset($_SESSION['user_id'])){
         ...
         <?php 
            if(mysqli_num_rows($sql_result_1) > 0){ ?>
    ...
    <!--                           end of button-->
            ...
            <?php 
            if(mysqli_num_rows($sql_result_1) > 0){ //CHK_ORDER_COUNT: check if there is a record ?> 
...
?>
<form action="process_order_2.php" method="get">
<!--     Order Form-->
     <div class="row">
