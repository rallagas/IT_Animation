...
<?php
 if(isset($_POST['update_item_btn'])){
     $ing_name = $_POST['upd_ing_name'];
     $ing_desc = $_POST['upd_ing_desc'];
     $ing_price = $_POST['upd_price_amt'];
     $ing_step = $_POST['upd_step_id'];
     $ing_id = $_POST['upd_ing_id'];
     
     $sql_upd_ing = "UPDATE `ingredients`
                       SET `ingredient_name` = '$ing_name'
                         , `step_id` = '$ing_step'
                         , `price_amt` = '$ing_price'
                         , `ingredient_description` = '$ing_desc'
                     WHERE `ingredient_id` = '$ing_id'
                       ";
     $exec_upd_ing = mysqli_query($conn, $sql_upd_ing);
     if($exec_upd_ing){
         header("location: ?page=1&update_success");
     }
     else{
         header("location: ?page=1&update_failed");
     }
                ...
                <?php }
                    ...
                    <form action="" method="post">
                        <div class="mb-3">
                             ...
                             <input type="hidden" name="upd_ing_id" value="<?php echo $_GET['ing_id'];?>">
                            <input type="text" name="upd_ing_name" class="form-control" value="<?php echo $info['ingredient_name'];?>">
                        </div>
                        <div class="mb-3">
                             <label for="" class="form-label">Description</label>
                            <input type="text" name="upd_ing_desc" class="form-control" value="<?php echo $info['ingredient_description'];?>">
                        </div>
                        <div class="mb-3">
                             <label for="" class="form-label">Price</label>
                            <input type="text" name="upd_price_amt" class="form-control" value="<?php echo $info['price_amt'];?>">
                        </div>
                        <div class="mb-3">
                             <label for="" class="form-label">Step</label>
                                <select name="upd_step_id" id="" class="form-select">
                        ...
                        <input type="submit" name="update_item_btn" class="btn btn-success">
                        ...
                        <div class="card-body">
                           <em class="card-link"><?php echo "Php " . number_format($row['price_amt'],2);?></em>
                            ...
                            <div class="card-footer">
                                ...
                                <a href="?page=1&deactivate_ingredient&ing_id=<?php echo $row['ingredient_id'];?>" class="btn btn-sm btn-danger">deactivate</a>
                            </div>
                    </div>
                    <?php
                }
