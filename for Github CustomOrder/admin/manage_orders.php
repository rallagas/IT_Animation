...
function get_total_orders($conn, $status){
    
    $sql_get_pending_orders = "SELECT count(distinct order_reference_number) as cnt
                                 FROM `multi_order`
                                 WHERE order_status = '$status'";
    $count_result = mysqli_query($conn, $sql_get_pending_orders);
    ...
    <div class="container-fluid">
        <div class="row">
           <div class="col-1"></div>
            ...
            <div class="col-2">Pending Orders (<?php echo get_total_orders($conn,'P'); ?>)</div>
            <div class="col-2">Delivered Orders (<?php echo get_total_orders($conn,'D'); ?>)</div>
            <div class="col-2">Cancelled Orders (<?php echo get_total_orders($conn,'X'); ?>)</div>
                ...
                <h3 class="display-5">Manage Orders (Multi Order)</h3>
                    ...
                    ?>
                      <div class="container-fluid">
                          <div class="row">
                              <div class="col-4">
                                  <h3>Pending (<?php echo get_total_orders($conn,'P'); ?>)</h3>
                                   <?php
